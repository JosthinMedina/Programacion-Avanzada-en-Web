...
CREATE OR ALTER PROCEDURE spIniciarSesionUsuario
    @Correo VARCHAR(150),
...
-- Primero, asegurarnos de que existan los roles
INSERT INTO Roles (nombre_rol, estado)
VALUES 
('Administrador', 1),
('Profesor', 1),
...
INSERT INTO Usuarios (id_rol, correo, contrasena, estado, fecha_registro)
VALUES 
(1, 'admin@sistema.com', '123456', 1, GETDATE());

-- Insertar un usuario profesor
INSERT INTO Usuarios (id_rol, correo, contrasena, estado, fecha_registro)
VALUES 
(2, 'profesor@sistema.com', '123456', 1, GETDATE());

-- Insertar un usuario estudiante
INSERT INTO Usuarios (id_rol, correo, contrasena, estado, fecha_registro)
VALUES 
(3, 'estudiante@sistema.com', '123456', 1, GETDATE());
